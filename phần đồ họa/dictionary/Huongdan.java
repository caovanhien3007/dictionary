...
public class Huongdan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Xóa từ :chọn từ cần xóa chọn Xóa từ hoặc ctrl+c \nđể loại từ ra khỏi dữ liệu từ điển\n\nThêm từ : chọn và thêm các thuộc tính của từ phần\nnghĩa của từ có thể viết trên nhiều dòng\n\nNhận ctrl +r để khởi động lại từ điển\n\nDữ liệu tài điển \nData.txt.\n\n\n");
